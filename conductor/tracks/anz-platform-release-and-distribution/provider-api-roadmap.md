...
The v9 import does not implement these APIs. The Commonwealth source validation
record confirms the official API surface, but runtime support remains blocked
until provider adapter mapping and tests land inside the single repository.
