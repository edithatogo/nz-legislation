...
| npm ANZ alias                 | npm registry                           | `anz-legislation`                | Future                     | AU truthfulness gate    |
| GitHub Packages               | GitHub Packages                        | scoped mirror                    | Existing/planned           | release workflow gate   |
