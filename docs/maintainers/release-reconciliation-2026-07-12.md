...
| Git branches             | `main`=`3da8c027`, `next`=`858dd835`, current branch=`7f0a209`                          | Branches exist; current feature branch is not a release branch.                                                                                          |
...
| Latest branch automation | Docs run `29156484950`; earlier CodeQL/package-mirror runs passed                       | Current branch automation is green for the verified runs; historical failures remain historical.                                                         |

## Release decision

The umbrella track is archived as a preparation record and remains external-submission-blocked. The npm
